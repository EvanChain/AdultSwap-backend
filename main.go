...
func main() {
	// 连接以太坊节点
	client, err := ethclient.Dial("https://api.zan.top/node/v1/eth/mainnet/f434bee9f3aa451aa36783a13d632500")
	if err != nil {
		log.Fatal(err)
	}
	...
	query := ethereum.FilterQuery{
		...
		Topics: [][]common.Hash{
			{common.HexToHash("0xc42079f94a6350d7e6235f29174924f928cc2ac818eb64fed8004e115fbcca67")}, // Swap 事件签名
		},
	}
...
// 打印结果
func printResults(events []SwapEvent) {
	...
	//调用ai
	mistral.PostMistral(question.String())
}
